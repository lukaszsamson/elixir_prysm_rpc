...
defmodule Ethereum.Eth.V1alpha1.BeaconStateElectra do
  @moduledoc false
  ...
  field :deposit_requests_start_index, 12001,
    type: :uint64,
    json_name: "depositRequestsStartIndex"

  field :deposit_balance_to_consume, 12002,
    type: :uint64,
    json_name: "depositBalanceToConsume",
    deprecated: false

  field :exit_balance_to_consume, 12003,
    type: :uint64,
    json_name: "exitBalanceToConsume",
    deprecated: false

  field :earliest_exit_epoch, 12004,
    type: :uint64,
    json_name: "earliestExitEpoch",
    deprecated: false

  field :consolidation_balance_to_consume, 12005,
    type: :uint64,
    json_name: "consolidationBalanceToConsume",
    deprecated: false

  field :earliest_consolidation_epoch, 12006,
    type: :uint64,
    json_name: "earliestConsolidationEpoch",
    deprecated: false

  field :pending_deposits, 12007,
    repeated: true,
    type: Ethereum.Eth.V1alpha1.PendingDeposit,
    json_name: "pendingDeposits",
    deprecated: false

  field :pending_partial_withdrawals, 12008,
    repeated: true,
    type: Ethereum.Eth.V1alpha1.PendingPartialWithdrawal,
    json_name: "pendingPartialWithdrawals",
    deprecated: false

  field :pending_consolidations, 12009,
    repeated: true,
    type: Ethereum.Eth.V1alpha1.PendingConsolidation,
    json_name: "pendingConsolidations",
    deprecated: false
end