...
defmodule Ethereum.Eth.V2.BeaconStateContainer do
  ...
  field :capella_state, 4,
    type: Ethereum.Eth.V2.BeaconStateCapella,
    json_name: "capellaState",
    oneof: 0
end
...
defmodule Ethereum.Eth.V2.RandaoRequest do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Ethereum.Eth.V2.RandaoResponse.Randao do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3

  field :randao, 1, type: :bytes, deprecated: false
end

defmodule Ethereum.Eth.V2.RandaoResponse do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3

  field :data, 1, type: Ethereum.Eth.V2.RandaoResponse.Randao
